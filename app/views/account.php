...
<html lang="<?= ACTIVE_LANG ?>">
    <head>
        ...
        <title><?= $Account->isAvailable() ?  htmlchars($Account->get("username")) : __("New Account") ?></title>
...
<!-- End Google Tag Manager (noscript) -->
        ...
        <?php 
            $TopBar = new stdClass;
            $TopBar->title = $Account->isAvailable() ?  htmlchars($Account->get("username")) : __("New Account");
            $TopBar->btn = false;
