...
<html lang="<?= ACTIVE_LANG ?>">
    <head>
        ...
        <title><?= __("Caption Templates") ?></title>
...
<!-- End Google Tag Manager (noscript) -->
        ...
        <?php 
            $TopBar = new stdClass;
            $TopBar->title = __("Caption Templates");
            $TopBar->btn = array(
                "icon" => "sli sli-grid",
                "title" => __("Add new"),
                "link" => APPURL."/captions/new"
            );
            require_once(APPPATH.'/views/fragments/topbar.fragment.php'); 
        ?>

        <?php require_once(APPPATH.'/views/fragments/captions.fragment.php'); ?>
